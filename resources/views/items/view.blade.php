    ...
    <div class="modal-dialog" style="background-color:#ffffff;">
        <form class="form-horizontal">
            ...
            <div class="form-group" id="quantity">
                ...
                <div class="col-sm-7">
                    <input style="background-color:#ffffff;" class="form-control" placeholder="No Available Quantity" id="view-quantity" name="quantity" readonly>
                </div>
            </div>
            ...
            <div class="form-group" id="cost">
                ...
                <div class="col-sm-7">
                    <input style="background-color:#ffffff;" class="form-control" placeholder="No Available Cost" id="view-cost" name="cost" readonly>
                </div>
            </div>
            ...
            <div class="form-group" id="price">
                ...
                <div class="col-sm-7">
                    <input style="background-color:#ffffff;" class="form-control" placeholder="No Available Cost" id="view-price" name="price" readonly>
                </div>
            </div>

            <div class="form-group" id="profit">
                <label class="control-label col-sm-4">Profit:</label>
                <div class="col-sm-7">
                    <input style="background-color:#ffffff;" class="form-control" placeholder="No Available Cost" id="view-profit" name="profit" readonly>
                </div>
            </div>
